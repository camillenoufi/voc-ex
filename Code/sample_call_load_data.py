...
if __name__ == '__main__':
   ...
   """
    embed_dict = dl.load_embedding_dict(fname='dict_dev_feats.pkl')
    print('Length of Feature Embeddings Dict:')
    print(len(embed_dict))
    print(embed_dict[filepath_list[0]].size())
    ...
    """
    label_dict = dl.load_label_dict(metadata_file='local_dev.csv')
